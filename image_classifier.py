...
class ImageClassifier:
    ...
    def __init__(self, root):
        ...
        default_font.configure(size=20)          # 14 可改成 16、18 直到你觉得合适
        ...
        self.copy_mode      = BooleanVar(value=False)   # True=复制  False=移动
    ...
    def show_welcome(self):
        ...
        txt = ("图片分类工具\n\n"
              ...
              "按下 A、S、D 可进行分类，按 W 跳过\n\n"

              "按 Ctrl+Z 可撤销上一次的移动（支持连续撤销）\n\n"
